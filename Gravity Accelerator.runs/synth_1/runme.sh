...
HD_PWD='C:/Users/akhil/verilog/Gravity Accelerator/Gravity Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gravity_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gravity_accelerator.tcl
